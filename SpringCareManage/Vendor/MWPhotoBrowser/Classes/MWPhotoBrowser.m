...
- (void)performLayout {
    ...
    // 显示删除按钮
    BOOL deleteButtonOnNavBar = !self.navigationItem.leftBarButtonItem;
    if (_deleteButton && deleteButtonOnNavBar) {
    ...
    if (_deleteButton && !deleteButtonOnNavBar) [items addObject:_deleteButton];
...
//    _photoCount = NSNotFound;
    ...
    if ([_delegate respondsToSelector:@selector(deletePhoto:deletePhotoIndex:)]) {
        [_delegate deletePhoto:self deletePhotoIndex:_currentPageIndex];
    }
