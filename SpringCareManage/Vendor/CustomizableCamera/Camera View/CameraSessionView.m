...
- (void)onTapDismissButton {
    __weak CameraSessionView *weakSelf = self;
    [UIView animateWithDuration:0.3 animations:^{
        weakSelf.center = CGPointMake(weakSelf.center.x, weakSelf.center.y*3);
    } completion:^(BOOL finished) {
        [weakSelf.captureManager stop];
    ...
    if ([sender isKindOfClass:[UITapGestureRecognizer class]]) {
        ...
        if (tap.state == UIGestureRecognizerStateRecognized) {
            ...
            [self focusAtPoint:location completionHandler:^{
                 [weakSelf animateFocusReticuleToPoint:location];
             }];
        }
    }
}
...
- (void)animateShutterRelease {
    ...
    [UIView animateWithDuration:.1 animations:^{
        weakSelf.cameraShutter.transform = CGAffineTransformMakeScale(1.25, 1.25);
    } completion:^(BOOL finished) {
        [UIView animateWithDuration:.1 animations:^{
            weakSelf.cameraShutter.transform = CGAffineTransformMakeScale(1, 1);
        } completion:^(BOOL finished) {
    ...
    switch ([[UIDevice currentDevice] orientation]) {
        case UIDeviceOrientationPortrait:
        {
            ...
            [UIView animateWithDuration:0.6 animations:^{
                ...
                weakSelf.cameraFlash.transform = transform;
                weakSelf.cameraFlash.center = CGPointMake(weakSelf.topBarView.center.x * 0.80, weakSelf.topBarView.center.y);
                
                weakSelf.cameraToggle.transform = transform;
                weakSelf.cameraToggle.center = CGPointMake(weakSelf.topBarView.center.x * 1.20, weakSelf.topBarView.center.y);
                
                weakSelf.cameraDismiss.center = CGPointMake(20, weakSelf.topBarView.center.y);
            }];
        }
            break;
        case UIDeviceOrientationLandscapeLeft:
        {
            ...
            [UIView animateWithDuration:0.6 animations:^{
                ...
                weakSelf.cameraFlash.transform = transform;
                weakSelf.cameraFlash.center = CGPointMake(weakSelf.topBarView.center.x * 1.25, weakSelf.topBarView.center.y);
                
                weakSelf.cameraToggle.transform = transform;
                weakSelf.cameraToggle.center = CGPointMake(weakSelf.topBarView.center.x * 1.60, weakSelf.topBarView.center.y);
                
                weakSelf.cameraDismiss.center = CGPointMake(weakSelf.topBarView.center.x * 0.25, weakSelf.topBarView.center.y);
            }];
        }
            break;
        case UIDeviceOrientationLandscapeRight:
        {
            ...
            [UIView animateWithDuration:0.6 animations:^{
                ...
                weakSelf.cameraFlash.transform = transform;
                weakSelf.cameraFlash.center = CGPointMake(weakSelf.topBarView.center.x * 0.40, weakSelf.topBarView.center.y);
                
                weakSelf.cameraToggle.transform = transform;
                weakSelf.cameraToggle.center = CGPointMake(weakSelf.topBarView.center.x * 0.75, weakSelf.topBarView.center.y);
                
                weakSelf.cameraDismiss.center = CGPointMake(weakSelf.topBarView.center.x * 1.75, weakSelf.topBarView.center.y);
            }];
        }
            break;
        default:;
